...
- **モザイクツール**: 複数矩形領域・移動/リサイズ/回転・キーフレームアニメーション(位置/サイズ/回転/表示)・粒度調整・リアルタイムプレビュー
- **ダークモード**: ライト/ダーク/システム連動の 3 モード
- **快適な素材確認**: メディアビンでのホバースクラブプレビュー、書き出し完了音、ソース動画に合わせた書き出しプリセット
